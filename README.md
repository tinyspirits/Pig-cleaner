...
![Demo Giao diện Heo](<img width="1510" height="910" alt="Screenshot 2026-07-14 at 11 18 21" src="https://github.com/user-attachments/assets/bebfc3d2-fc6c-4c3d-98f0-e60b2fbcbf0f" />)
...
- **Dọn dẹp Cache thông minh:** Hỗ trợ quét và dọn dẹp an toàn các loại cache phổ biến chiếm nhiều dung lượng:
  ...
  ![Demo Bảng Dọn Cache](<img width="318" height="481" alt="Screenshot 2026-07-14 at 11 19 08" src="https://github.com/user-attachments/assets/87146206-7160-467d-97b6-47f8913c03e1" />)

- **Tự động dọn dẹp:** Thiết lập khoảng thời gian để heo tự động đi ăn rác (30 phút, 1 tiếng, 2 tiếng, 6 tiếng).
  
  ![Demo Bảng Cài Đặt](<img width="322" height="502" alt="Screenshot 2026-07-14 at 11 17 47" src="https://github.com/user-attachments/assets/294be737-5161-44c7-8483-19e2fc56d36a" />)
...
- **Minh bạch & An toàn:** Giao diện xem thống kê chi tiết lượng rác đã dọn, dung lượng từng thư mục cache trước khi quyết định xóa.
  ...
  ![Demo Thống Kê](<img width="207" height="166" alt="Screenshot 2026-07-14 at 11 20 13" src="https://github.com/user-attachments/assets/e4d35dbf-78af-4ff9-8ce8-4ff08c50f554" />
)
