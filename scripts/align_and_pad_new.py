...
groups = {
    'idle':  [('idle.png', 1), ('idle2.png', 3), ('idle3.png', 4), ('wink.png', 2)],
    'walk':  [('walk1.png', 5), ('walk2.png', 6), ('walk3.png', 7), ('walk4.png', 8), ('walk5.png', 9)],
    'sleep': [('sleep1.png', 18), ('sleep2.png', 19)],
    'happy': [('happy.png', 13), ('happy2.png', 14)],
    'drag':  [('drag1.png', 21), ('drag2.png', 22), ('drag3.png', 23)],
    'misc':  [('sniff.png', 10), ('alert.png', 11)]
}
...
for group_name, items in groups.items():
    ...
    ref_img = process_img(f'scripts/extracted_new/pig_{ref_id}.png')
    ...
    for name, pid in items[1:]:
        img = process_img(f'scripts/extracted_new/pig_{pid}.png')
