...
in_dir = 'src/renderer/assets/sprites/dive_frames'
out_dir = 'src/renderer/assets/sprites/dive_frames_aligned'
...
# frames needed: pig_11 to pig_22
...
print("Done padding and aligning dive frames!")
